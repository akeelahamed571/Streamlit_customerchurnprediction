...
with st.sidebar:
	...
	if (selected == 'Diabetes Prediction'):
		    ...
		    if st.button('Diabetes Test Result'):
		        diab_prediction = model.predict([[inputQuery1, inputQuery2, inputQuery3,inputQuery4, inputQuery5, inputQuery6, inputQuery7, inputQuery8,inputQuery9,inputQuery10,inputQuery11,inputQuery12,inputQuery13,inputQuery14,inputQuery15,inputQuery16,inputQuery17,inputQuery18,inputQuery19]])
